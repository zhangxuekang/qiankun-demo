...
function createSandbox(appName, elementGetter, singular, scopedCSS, excludeAssetFilter) {
  ...
  var bootstrappingFreers = (0, _patchers.patchAtBootstrapping)(appName, elementGetter, sandbox, singular, scopedCSS, excludeAssetFilter); // mounting freers are one-off and should be re-init at every mounting time
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                mountingFreers = (0, _patchers.patchAtMounting)(appName, elementGetter, sandbox, singular, scopedCSS, excludeAssetFilter);
                /* ------------------------------------------ 3. 重置一些初始化时的副作用 ------------------------------------------*/
